// ColorString Class: provide static functions to convert a string to a string with any color
public class ColorString {
    ...
    public static String getColor(String prompt, String color){
        ...
        if (color.equals("yellow")){return ANSI_YELLOW+prompt+ANSI_RESET;}
        if (color.equals("blue")){return ANSI_CYAN+prompt+ANSI_RESET;}
        return prompt;
    }
